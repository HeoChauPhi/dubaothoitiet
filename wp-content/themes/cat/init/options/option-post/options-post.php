<?php
add_action( 'cmb2_admin_init', 'cat_sidebar_post_metaboxes' );
function cat_sidebar_post_metaboxes() {
  ...
  $cmb = new_cmb2_box( array(
    ...
    'object_types'  => array('news'), // Post type or any post type use: cat_list_posttype()
    'context'       => 'normal',
    'priority'      => 'high',
    'show_names'    => true,
  ) );
