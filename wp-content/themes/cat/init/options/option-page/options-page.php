<?php
add_action( 'cmb2_admin_init', 'cat_sidebar_option_metaboxes' );
function cat_sidebar_option_metaboxes() {
  ...
  $cmb = new_cmb2_box( array(
    ...
    'object_types'  => array( 'page', ), // Post type or any post type use: cat_list_posttype()
    'context'       => 'normal',
    'priority'      => 'high',
    'show_names'    => true,
  ) );
...
add_action( 'cmb2_admin_init', 'cat_page_option_metaboxes' );
function cat_page_option_metaboxes() {
