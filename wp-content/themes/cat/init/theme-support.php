...
function cat_move_comment_form_below( $fields ) {
    $comment_field = $fields['comment'];
    unset( $fields['comment'] );
    $fields['comment'] = $comment_field;
    return $fields;
}
add_filter( 'comment_form_fields', 'cat_move_comment_form_below' );

// Set per page on each page
add_action( 'pre_get_posts',  'cat_set_posts_per_page'  );
function cat_set_posts_per_page( $query ) {
...
function cat_get_widget_id($widget_instance) {
...
add_action('in_widget_form', 'cat_get_widget_id');

// Sidebar widget arena
add_action( 'widgets_init', 'cat_create_sidebar_Widget' );
function cat_create_sidebar_Widget() {
...
// Header widget arena
add_action( 'widgets_init', 'cat_create_header_Widget' );
function cat_create_header_Widget() {
...
// Footer widget arena
add_action( 'widgets_init', 'cat_create_footer_Widget' );
function cat_create_footer_Widget() {
